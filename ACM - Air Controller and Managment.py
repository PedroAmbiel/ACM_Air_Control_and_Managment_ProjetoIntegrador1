...
def calculoParametrosMedidos (mp10, mp25, o3, co, no2, so2):
    if mp10 != 0:
        if mp10 <= 50:
    ...
    if so2 != 0:
        ...
        so2_calc = 0
    return [mp10_calc, mp25_calc, o3_calc, co_calc, no2_calc, so2_calc]


def classificacaoIndice (mp10_calc, mp25_calc, o3_calc, co_calc, no2_calc, so2_calc): 
    print("\n_________________________________________")
    print("\nResultado da Qualidade do Ar: ")
...
while reinicio_Prog:# Laço do programa, irá repetir o programa todo
    while True:
        try:#Verifica se há alguma letra sendo inserida 
            ...
            print("\n_________________________________________")
            print("\nIndicação dos valores dos parâmetros: ")    
            ...
            conc_medida = calculoParametrosMedidos(mp10, mp25, o3, co, no2, so2)
            classificacaoIndice(conc_medida[0],conc_medida[1],conc_medida[2],conc_medida[3],conc_medida[4],conc_medida[5])
